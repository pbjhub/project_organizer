...
if not os.path.exists('existing_projects.csv'):
    ...
    MOCK_PROJECTS={"Proyecto" : ["Projecto 1", "Projecto 2"],
                   "Conceptos": ["Render cocina", "Render completo"],
                   "Nombre del cliente" : ["C1", "C2"],
                   "Total con IVA": [10000, 8000],
                   "Anticipo %": [30, 40],
                   "Anticipo con IVA": [3000, 3200],
                   "Renderista": ["Renderist 1", "Renderist 2"],
                   "Comisión": [30, 30],
                   "Comisión Anticipo": [900, 320],
                   "Anticipo abonado": ["Sí", "No"],
                   "Fecha de pago anticipo" : ["03/05/25", None]}
